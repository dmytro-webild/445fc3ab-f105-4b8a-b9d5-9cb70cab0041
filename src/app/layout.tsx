...
export const metadata: Metadata = {
  title: "C Wall Builders | Professional Construction Services",  description: "Expert general contractor specializing in residential, commercial, and industrial construction. 20+ years of quality craftsmanship.",  keywords: "construction, general contractor, building, masonry, residential construction, commercial building",  openGraph: {
    title: "C Wall Builders | Professional Construction",    description: "20+ years of expert construction services. Get your free project quote today.",    type: "website",    siteName: "C Wall Builders"},
  twitter: {
    card: "summary_large_image",    title: "C Wall Builders",    description: "Professional construction and building services"},
  robots: {
    index: true,
    follow: true,
  },
